  ...
  autoPlay
   loop
    ...
    <div className='absolute bottom-[15%] flex flex-col items-center gap-5'>
        ...
        <div className='flex item-center gap-5 text-3xl font-extrabold text-gray-200'>
        ...
        <p className='max-w-[80%] text-center text-[#babaff]'>
           Notice: This is a demo gaming website for showcasing purposes only. All game content and assets are fictional and do not represent any real games or intellectual properties. 
        </p>
    </div>
    <div className='absolute bottom-40 lg:right-24 right-5 mt-24 animate-bounce sm:inline-block hidden'>
        <div className='flex flex-col items-center'>
            ...
            <p classNmae='text-[#babaff] mt-2'>Scroll Down</p>
        </div>
    </div>
    </main>
  )
